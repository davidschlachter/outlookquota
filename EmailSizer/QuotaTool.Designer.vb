...
Partial Public NotInheritable Class QuotaTool
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _QuotaTool As QuotaTool
    ...
    Friend Shared Property QuotaTool() As QuotaTool
        Get
            Return _QuotaTool
        End Get
        Set(ByVal value As QuotaTool)
            If (_QuotaTool Is Nothing) Then
                _QuotaTool = value
            Else
    ...
    Friend Shared ReadOnly Property FormRegions() As ThisFormRegionCollection
        Get
            If (_ThisFormRegionCollection Is Nothing) Then
                _ThisFormRegionCollection = New ThisFormRegionCollection(Globals.QuotaTool.GetFormRegions)
            End If
...
Partial Friend NotInheritable Class ThisFormRegionCollection
    ...
    Default Friend Overloads ReadOnly Property Item(ByVal explorer As Microsoft.Office.Interop.Outlook.Explorer) As WindowFormRegionCollection
        Get
            Return CType(Globals.QuotaTool.GetFormRegions(explorer, GetType(WindowFormRegionCollection)), WindowFormRegionCollection)
        End Get
    End Property
    ...
    Default Friend Overloads ReadOnly Property Item(ByVal inspector As Microsoft.Office.Interop.Outlook.Inspector) As WindowFormRegionCollection
        Get
            Return CType(Globals.QuotaTool.GetFormRegions(inspector, GetType(WindowFormRegionCollection)), WindowFormRegionCollection)
        End Get
    End Property
End Class
